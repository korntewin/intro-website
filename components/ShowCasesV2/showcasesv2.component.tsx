...
export default function ShowCasesV2({ highlights }: ShowCasesV2Props) {
  ...
  // Auto-rotate every 3 seconds with progress tracking
  useEffect(() => {
    ...
    // Animation interval for progress bar (updates every 30ms)
    progressIntervalRef.current = setInterval(() => {
      setProgress(prev => {
        const newProgress = prev + (30 / 3000 * 100);
  ...
  }, [highlights.length, currentIndex, isPaused]);
        ...
        <div className={styles.showcaseContent}>
          ...
          <div className={styles.textContainer}>
            ...
            {currentHighlight.link && (
              <a href={currentHighlight.link} className={styles.projectLink} target="_blank" rel="noopener noreferrer">
                View Project
